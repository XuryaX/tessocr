...
public class ImageToDocument {
	...
	public void transform(int optype) throws OCRException,
			FileNotFoundException, IOException, SpellCheckException {
		ArrayList<FormatText> content = identify();
		draft(content, optype, "");
	}

	public void transform(int optype, String path) throws OCRException,
			FileNotFoundException, IOException, SpellCheckException {
		ArrayList<FormatText> content = identify();
	...
	private void draft(ArrayList<FormatText> content, int optype, String path)
			throws FileNotFoundException, IOException, SpellCheckException {
		FormatText line;
		WriterModel write;
